    ...
    public partial class Tables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AgeStages", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClothesClassifications", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HumanClass", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisplayName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true, computedColumnSql: "[FirstName]+' '+ [LastName]"),
                    NameOfImage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HumanClassId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameOfImage = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Discount = table.Column<int>(type: "int", nullable: true),
                    AgeStageId = table.Column<int>(type: "int", nullable: false),
                    MarkaId = table.Column<int>(type: "int", nullable: false),
                    HumanClassId = table.Column<int>(type: "int", nullable: false),
                    ClothesClassificationId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.ClothesClassificationId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PMId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NameOwnerCard = table.Column<string>(type: "nvarchar(100)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_paymentDetails_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RevesationSystems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RevesationSystems_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserProducts", x => new { x.ApplicationUserId, x.ProductId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "ProductRevesationSystem",
                columns: table => new
                {
                    ProductsId = table.Column<int>(type: "int", nullable: false),
                    RevesationSystemsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductRevesationSystem", x => new { x.ProductsId, x.RevesationSystemsId });
                    table.ForeignKey(
                        name: "FK_ProductRevesationSystem_RevesationSystems_RevesationSystemsId",
                        column: x => x.RevesationSystemsId,
                        principalTable: "RevesationSystems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_HumanClassId",
                table: "AspNetUsers",
                column: "HumanClassId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_paymentDetails_ApplicationUserId",
                table: "paymentDetails",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductRevesationSystem_RevesationSystemsId",
                table: "ProductRevesationSystem",
                column: "RevesationSystemsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RevesationSystems_ApplicationUserId",
                table: "RevesationSystems",
                column: "ApplicationUserId");
